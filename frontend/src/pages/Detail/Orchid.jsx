      ...
      <div className="money-container">
                  ...
                  <div className="money-top">
                    <div className="image-wrapper">
                      <img src={assets.orchid} className="money-img" />
                      <img src={assets.favorite} className="heart-icon" alt="Heart Icon" />
                    </div>
      
                    <div className="money-details">
                      <h2>White Orchid</h2>
                      <p className="pricep">NPr. 1500</p>
                      <p className="desc">
                        An elegant Orchid is a perfect gift to send a loved one or to just treat yourself. 
                        This White Orchid is 24-30″ tall from the bottom of the pot to the highest petal.
                         White Orchids trace their symbolic roots of gratitude, admiration,
                         and respect back to the early Victorian era and to the traditions of Japanese royalty. 
                        Orchids give a tropical yet sophisticated feel to any room. 
                      </p>
                  ...
                  <div className="money-bottom">
                    ...
                    <img src={assets.o_plant}  className="bottom-img" />
                  </div>
