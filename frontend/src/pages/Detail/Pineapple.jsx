       ...
       <div className="money-container">
                  ...
                  <div className="money-top">
                    <div className="image-wrapper">
                      <img src={assets.pinetree} className="money-img" />
                      <img src={assets.favorite} className="heart-icon" alt="Heart Icon" />
                    </div>
      
                    <div className="money-details">
                      <h2>Bromeliad Pineapple</h2>
                      <p className="pricep">NPr. 2000</p>
                      <p className="desc">
                       Have you ever wanted to grow your own adorable pineapple indoors? With the Bromeliad Pineapple,
                        you can! This bromeliad sprouts a fun ornamental pineapple from a whorl of long green leaves. 
                       Sure to spark a conversation with your next dinner guests, you’ll know your pineapple fruit has 
                       reached maturity when it turns fragrant and a brighter shade of yellow. Although this variety is 
                       not grown for edible consumption, it’s still a unique gift or addition to any personal collection
                      </p>
                  ...
                  <div className="money-bottom">
                    ...
                    <img src={assets.p_apple}  className="bottom-img" />
                  </div>
