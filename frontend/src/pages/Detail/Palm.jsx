      ...
      <div className="money-container">
                        ...
                        <div className="money-top">
                          <div className="image-wrapper">
                            <img src={assets.palm} className="money-img" />
                            <img src={assets.favorite} className="heart-icon" alt="Heart Icon" />
                          </div>
            
                          <div className="money-details">
                            <h2>Cat Palm</h2>
                            <p className="pricep">NPr.1100</p>
                            <p className="desc">
                              With dense foliage and lush fronds, the Bamboo Palm makes a statement. 
                              An air-purifying plant in a European Ecopot:
                        ...
                        <div className="money-bottom">
                          ...
                          <img src={assets.plm}  className="bottom-img" />
                        </div>
